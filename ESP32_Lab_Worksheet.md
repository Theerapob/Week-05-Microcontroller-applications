...
|----------------|-------------------|----------------------|-------------|
| Stack | stack_var | 0x3FFB2C10 | SRAM |
| Global SRAM | sram_buffer | 0x3FFB0000 | SRAM |
| Flash | flash_string | 0x400D0A50 | Flash |
| Heap | heap_ptr | 0x3FFB5000 | SRAM |

**Table 2.2: Memory Usage Summary**

| Memory Type | Free Size (bytes) | Total Size (bytes) |
|-------------|-------------------|--------------------|
| Internal SRAM | 210,432 | 520,192 |
| Flash Memory | 3,900,000 | 4,194,304 (4 MB) |
| DMA Memory | 24,576 | 32,768 |
